...
/*   Updated: 2023/07/06 08:24:26 by joaoalme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    init_philos_thread(t_data *info)
{
    ...
    i = 1;
    info->philo[i].threads_ph = malloc(sizeof(pthread_t) * info->nb_of_philos);
...
void    start_info(t_data *info, int ac, char **args)
{
    ...
    info->var = 0;
    info->philo->threads_ph = malloc(sizeof(t_philo) * info->nb_of_philos);
}
